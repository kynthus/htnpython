...
def q05():
    ...
    """
    input_word = raw_input('キーボードから何か入力しなさい：')
...
def q09():
    ...
    """
    input1 = raw_input('文字列その1：')
    input2 = raw_input('文字列その2：')
    input3 = raw_input('文字列その3：')
...
def q10():
    ...
    無印のpythonコマンドで実行すること。
    """
    input1 = raw_input('1人目：')
    input2 = raw_input('2人目：')
    input3 = raw_input('3人目：')
    input4 = raw_input('4人目：')
    input5 = raw_input('5人目：')
