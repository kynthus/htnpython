/******************************************************************************/
/**
 * @addtogroup pycaccess
 * @file       pycaccess.c
 * @brief      Python/C APIにおけるクラス(アクセッサ持ち)
 * @date       2019-12-08
...
PyMODINIT_FUNC PyInit_pycaccess(void);

#else

PyMODINIT_FUNC PyInit_pycaccess();
 ...
 */
#if defined(__STDC__) || defined(__cplusplus) || defined(c_plusplus)
static struct PyModuleDef *pycaccess_module_info(void)
#else
static struct PyModuleDef *pycaccess_module_info()
#endif
{
...
#endif
{
     ...
     * エラー発生時は手動で解放する
     */
    module_info = PyModule_Create(pycaccess_module_info());
